...
class CommandHandler extends Exceptions_1.default {
    ...
    startRcc(game) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let rccCid;
            if (!dockerEnabled) {
                const rccPath = Config_1.default.rcc || path.join(__dirname, 'C:\\Users\\Mark\\Desktop\\ch2\\economysimulator\\src\\services\\RCCService\\');
                const rccExecutable = rccPath + (os.platform() === 'win32' ? 'RCCService.exe' : 'rcc');
                rcc = cp.spawn(rccExecutable, ['-Console', '-PlaceId:1818', "-port 64989", '-Content', Config_1.default.content || path.join(rccPath, './content/')], {
                    cwd: rccPath,
                    stdio: 'pipe',
                });
            }
    ...
    GenerateThumbnailTexture(assetId, assetTypeId) {
        return __awaiter(this, void 0, void 0, function* () {
            const jobRequest = this.createSoapRequest(scripts.imageTexture
                ...
                .replace(/358843/g, assetTypeId.toString()), uuid.v4());
            this.addToQueue(jobRequest);
            return (yield (0, rendering_1.getResult)(jobRequest.jobId, 1)).thumbnail;
        });
    }
    /**
