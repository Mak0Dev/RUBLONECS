    ...
    public class BypassController : ControllerBase
    {
        ...
        public Dictionary<string,dynamic> GetAppSettings(string? apiKey = null)
        {
            ...
            var flags = new FastFlagResult().AddFlags(new List<IFastFlag>
            {
                ...
                // These settings are intentionally returned for both desktop and mobile
                // clients. They make the revival endpoints usable without relying on
                // Roblox-hosted client settings.
                new FastFlag("GameJoinEnabled", true),
                new FastFlag("ContentProviderEnabled", true),
                new FastFlag("HttpServiceEnabled", true),
