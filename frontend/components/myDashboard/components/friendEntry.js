  ...
  return <div className={s.friendEntry}>
    <Link href={`/users/${props.id}/profile`}>
      <a>
        ...
        <p className={s.username}>{props.name} {props.isVerified && <img src="/verified.svg" alt="Verified" style={{width: '16px', height: '16px', marginLeft: '4px', verticalAlign: 'middle'}} />}</p>
      </a>
    </Link>
  </div>
}
