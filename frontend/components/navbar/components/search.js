...
const SearchIcon = (props) => {
  ...
  return <span className={`${s.icon} icon-nav-search custom-search-icon`}></span>
}
...
const useSuggestionEntryStyles = createUseStyles({
  text: {
    ...
    marginBottom: 0,
    fontWeight: 400,
    color: 'var(--custom-search-suggestion-text, rgb(52, 52, 52))',
    '&:hover': {
      boxShadow: '4px 0 0 0 var(--custom-search-suggestion-hover, #FFAA5A) inset',
    },
  },
  link: {
    color: 'var(--custom-search-suggestion-text, rgb(52, 52, 52))',
...
const useSuggestionStyles = createUseStyles({
  container: {
    background: 'var(--custom-search-suggestion-background, white)',
    color: 'var(--custom-search-suggestion-text, #343434)',
    position: 'fixed',
...
const useSearchStyles = createUseStyles({
  wrapper: {
    padding: '4px 2px',
    background: 'var(--custom-search-background, white)',
    color: 'var(--custom-search-text, #191919)',
    borderRadius: '2px',
    border: '1px solid var(--custom-search-border, #c3c3c3)',
    width: '100%',
  },
  searchInput: {
    width: '100%',
