...
const useNavSideBarStyles = createUseStyles({
  ...
  card: {
    width: '175px',
    background: 'var(--custom-sidebar-background, #f2f2f2)',
    color: 'var(--custom-sidebar-text, #1e1e1f)',
    height: '100vh',
    paddingLeft: '10px',
    paddingRight: '10px',
  },
  ...
  divider: {
    borderBottom: '2px solid var(--custom-sidebar-divider, #c3c3c3)',
    height: '2px',
    width: '100%',
  },
  upgradeNowButton: {
    marginTop: '10px',
    background: 'var(--custom-upgrade-background, #C15C3F)',
    fontSize: '15px',
    fontWeight: 500,
    width: '100%',
    paddingTop: '8px',
    paddingBottom: '8px',
    textAlign: 'center',
    color: 'var(--custom-upgrade-text, white)',
    borderRadius: '4px',
    '&:hover': {
      background: 'var(--custom-upgrade-hover-background, #FFAA5A)',
    },
  },
});
...
const NavSideBar = props => {
  ...
  // Legacy character editor is the only supported avatar menu.
  const characterUrl = '/My/Character.aspx';
  ...
  return <div className={s.container}>
    <div className={s.card} style={{ paddingTop: paddingTop }}>
	  ...
	  <LinkEntry name='Discord' url='https://discord.gg/Z9dapErpmU' icon='icon-nav-blog' />
