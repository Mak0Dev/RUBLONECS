...
const PlayButton = props => {
  ...
  const onClick = e => {
    if (gameDetails.placeDetails && gameDetails.placeDetails.isPlayable === false) return;
  ...
  // A revival place is playable unless the backend explicitly reports it as unavailable.
  // Avoid the old Roblox-style false/undefined default that permanently disabled Play.
  const isDisabled = gameDetails.placeDetails?.isPlayable === false;
