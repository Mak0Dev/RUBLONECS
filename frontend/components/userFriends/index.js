                      ...
                      <div className='col-4'>
                        <div className={s.imageWrapper}>
                          <Link href={`/users/${v.id}/profile`}>
                            <a>
                              <PlayerImage id={v.id} name={v.name} width={90} height={90} useHeadshot={true} />
                            </a>
                          </Link>
                        </div>
                      </div>
                          ...
                          <p className={'mb-0 font-size-18 ' + s.username}>
                            <Link href={`/users/${v.id}/profile`}>
                              <a className='text-dark'>
                                {v.name} {v.isVerified && <img src="/verified.svg" alt="Verified" style={{width: '16px', height: '16px', marginLeft: '4px', verticalAlign: 'middle'}} />}
                              </a>
                            </Link>
                          </p>
                        </div>
