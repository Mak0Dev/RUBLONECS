...
<Main>
    <div class="row">
        <div class="col-12">
            ...
            {#if result && result.assetId !== undefined}
                <p>Link: <a href={`/catalog/${result.assetId}/--`}>View on site</a></p>
                <p>Product: <a href={`/admin/product/update?assetId=${result.assetId}`}>Update Product</a></p>
            {/if}
        </div>
